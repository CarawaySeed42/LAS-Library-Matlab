classdef VariableNames
    %VariableNames Class with static methods to create valid names
    %   for matlab variables
    % Copyright (c) 2022, Patrick Kümmerle
    % Licence: see the included file
    
    methods(Static)
        function validVarName = MakeValid(varName)
            % validVarName = MakeValid(varName)
